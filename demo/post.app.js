...
var path = 'http://localhost:9000/http-hmac-javascript/demo/post.php?myQueryParameter=90210#myAnchor';
var signed_headers = {
...
var sign_parameters = { request: request, method: method, path: path, signed_headers: signed_headers, content_type: content_type, body: body };
