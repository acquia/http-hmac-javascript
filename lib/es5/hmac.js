  ...
  _createClass(AcquiaHttpHmac, [{
    ...
    value: function sign(_ref3) {
      var request = _ref3.request,
          ...
          signed_headers = _ref3$signed_headers === undefined ? {} : _ref3$signed_headers,
          _ref3$content_type = _ref3.content_type,
          content_type = _ref3$content_type === undefined ? this.config.default_content_type : _ref3$content_type,
      ...
      var headers = this.getHeaders({ method: method, path: path, signed_headers: signed_headers, content_type: content_type, body: body });
